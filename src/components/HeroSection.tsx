...
const ways = [
  { icon: 'Mountain', label: 'المناظر الطبيعية', direction: 'الشمال' },
  { icon: 'Sun', label: 'الضوء', direction: 'الجنوب' },
  { icon: 'Sprout', label: 'النمو', direction: 'الشرق' },
  { icon: 'Scale', label: 'التوازن', direction: 'الغرب' },
];
    ...
    <section className="relative h-screen w-full overflow-hidden bg-black" dir="rtl">
      ...
      <div className="relative z-10 flex h-full items-center">
        <div className="container mx-auto px-8 md:px-16">
          <div className="flex max-w-3xl flex-col gap-8 mr-auto">
            <div
              className={cn(
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-white/60 text-sm tracking-[0.15em] uppercase font-light">
                  استوديو معماري
                </span>
              </div>
              ...
              <p className="text-xl font-light text-white/70 md:text-2xl mt-4 max-w-xl leading-relaxed">
                نصمم مساحات مستوحاة من الحكمة القديمة للاتجاهات الأربعة
              </p>
            </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                {ways.map((way) => (
                  <div key={way.direction} className="flex items-center gap-3 group">
                    ...
                    <div>
                      <p className="text-white/40 text-xs tracking-wider">{way.direction}</p>
            ...
            >
              <a
                href="#contact"
                className="inline-flex items-center gap-2 bg-white text-black px-8 py-3 text-sm tracking-wider hover:bg-white/90 transition-colors"
              >
                ناقش مشروعك
              ...
              <a
                href="#portfolio"
                className="inline-flex items-center gap-2 border border-white/30 text-white px-8 py-3 text-sm tracking-wider hover:border-white/60 transition-colors"
              >
                أعمالنا
              </a>
            </div>
